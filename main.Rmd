...
keyword: [linear mixed model, multi-level model, hierarchical model, panel data model, model specification, model formulae, symbolic model formulae, model API]
...
* `y` \texttt{\midtilde\ }`-1:x` simplifies to `y` \texttt{\midtilde\ }`1 - 1`.
